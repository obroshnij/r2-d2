    ...
    legal: {
      hosting_abuse: {
        ...
        resource: {
          ...
          upgrade:         Legal::HostingAbuse::Resource::Upgrade.where(hidden: false).as_json(only: [:id, :name]),
          ...
          file_type:       Legal::HostingAbuse::Resource::FileType.all.as_json(only: [:id, :name])
        },
        spam: {

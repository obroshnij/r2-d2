class Domains::Compensation::Stats::ClientSatisfactionByDept
  ...
  def count_cases dept, compensations
    ...
    { department: dept,
      count: { satisfied: satisfied, not_satisfied: not_satisfied, not_sure: not_sure },
      percent: { satisfied: percent(satisfied, by_dept.count), not_satisfied: percent(not_satisfied, by_dept.count), not_sure: percent(not_sure, by_dept.count) }
    }
  end

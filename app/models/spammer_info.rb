class SpammerInfo < ActiveRecord::Base
  ...
  validates :amount_spent, :registered_domains, :abused_domains, :locked_domains, :abused_locked_domains, presence: true, if: :new_report?
  validates :amount_spent, numericality: true, if: :new_report?
  validates :registered_domains, :abused_domains, :locked_domains, :abused_locked_domains, numericality: { only_integer: true }, if: :new_report?
